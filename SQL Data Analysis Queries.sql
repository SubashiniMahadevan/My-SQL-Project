...
#total pay for job titles limit to 5 rows
SELECT b.total_pay,e.job_title FROM basepayments b INNER JOIN employee e ON e.employee_no = b.employee_no ORDER BY b.total_pay DESC LIMIT 5;

SELECT AVG(b.regular_pay) AS averge_regular_pay,e.gender FROM basepayments b INNER JOIN employee e ON e.employee_no = b.employee_no GROUP BY e.gender;
